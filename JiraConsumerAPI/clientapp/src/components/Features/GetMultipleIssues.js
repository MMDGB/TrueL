...
class GetMultipleIssues extends Component {
    componentWillMount() {
        localStorage.setItem("currentPage","Get-Multiple-Issues")
    }
    render() {

        return (
            <div className={"paperAnchorTop"}>
                <Navigation place={"multiple"}/>
                <List display="inline-block">
                    <ListItem>
                        ...
                        <Box display="flex" color="text.primary" clone>
                            <List>
                                <ListItem >
                                    <IssueSelection mode={'multiple'} />
                                </ListItem>
                                <ListItem>
                                    <ExportCSV mode={'multiple'} />
                                </ListItem>
                            </List>
                        </Box>
                    </ListItem>
...
export default connect(mapStateToPropsExcel, mapDispatchToPropsExcel)(GetMultipleIssues);
