...
import NewTechTable from '../Layout/NewTechTable';


class NewTechByIssue extends Component {
    componentWillMount() {
        localStorage.setItem("currentPage","New-Tech-By-Issue")
      }
    render() {
        return (
...
export default connect(mapStateToPropsExcel, mapDispatchToPropsExcel)(NewTechByIssue);
